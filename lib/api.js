...
export const getDocument = async (videoFileNumber, includeImages = false) => {
  // By default, exclude images for faster loading (can be 10x faster)
  // Set includeImages=true only when images are actually needed
